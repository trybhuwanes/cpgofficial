...
@section('content')
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <a href="{{ route('collaboration') }}">
                <button data-aos="fade-up" data-aos-duration="1500" type="button"
                    class="text-white bg-black hover:bg-orange-500 focus:outline-none focus:ring-4 font-medium rounded-full text-lg px-5 py-2.5 text-center me-2 mb-2 ">See
                    More</button>
            </a>
    ...
    <div class="grid w-full h-auto xl:flex xl:flex-row bg-orange-500 xl:px-36 xl:p-24 sm:py-24 sm:items-center sm:justify-center">
        <div data-aos="fade-up" data-aos-duration="1500" class="w-full xl:w-1/2 mb-10 xl:mb-0 xl:mr-10 xl:items-start sm:items-center sm:justify-center">
            ...
            <div class="">
                <img class="object-cover w-full h-[380px] xl:w-[550px] sm:w-[480px] rounded-[20px]"
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="w-full xl:w-1/2 justify-center items-center ">
            <div class="text-4xl xl:text-6xl text-white mb-10 flex flex-wrap">
                <div class="mr-10">
                    <span
                        class="mb-3 flex tabular-nums text-4xl xl:text-5xl text-white transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)]"
            ...
            <div class="grid text-orange-100">
                ...
                <a href="{{ route('about') }}">
                    <button
                        class="bg-black hover:bg-orange-700 px-8 py-4 text-white font-bold text-center rounded-full mt-5 max-w-[200px]">
                        Learn More!
                    </button>
                </a>
            </div>
    ...
    <div class="grid w-full xl:flex xl:flex-row bg-orange-500 xl:px-36 xl:p-24 sm:py-24 sm:px-20 sm:items-center sm:justify-center">
        <div data-aos="fade-up" data-aos-duration="1500" class="xl:w-1/2">
            <div class="text-5xl text-white first-line:mb-10 font-bold mb-5 xl:items-start sm:items-center sm:justify-center">
                Frequently Asked Questions
            </div>
            <div class=" mr-20">
                <img class="object-cover w-full xl:w-[550px] h-[331px] rounded-[20px] justify-center items-center "
        ...
        <div class="flex flex-col px-36 py-24">
            ...
            <div data-aos="fade-up" data-aos-duration="1500"
                ...
                <div class="w-full sm:w-1/2 md:w-2/5 lg:w-1/4 xl:w-1/4 mb-5">
                    <div class="w-full h-[480px] bg-white flex flex-col rounded-[20px] mb-5 p-7 items-start">
