...
@section('content')
    ...
    <div data-aos="lg:fade-up-up" data-aos-duration="1500" class="grid lg:grid-cols-3 grid-cols-1 gap-4 mx-16 lg:mx-36 mb-16">
        {{-- CARD FOTO 1 --}}
        <div class="h-auto bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-white dark:border-gray-100">
            <img class="block h-80 lg:h-36 object-cover w-full rounded-t-lg" src="{{ asset('images\csr\csr-2024-charity.jpeg') }}" alt="CSR Maret 2024 Charity" />
            <div class="px-5 py-3">
                <h6 class="text-3xl lg:text-lg font-bold tracking-tight text-black dark:text-black">CSR 2024 Charity Event
                </h6>
                <p class="text-2xl lg:text-sm text-black dark:text-black">Maret 2024</p>
            </div>
        </div>

        {{-- CARD FOTO 2  --}}
        <div class="h-auto bg-white border border-gray-200 rounded-lg shadow-2xl dark:bg-white dark:border-gray-100">
            <img class="block h-80 lg:h-36 object-cover w-full rounded-t-lg" src="{{ asset('images\csr\csr-mei-2023-digital-office.jpg') }}" alt="CSR Mei 2023 Digital Office" />
            <div class="px-5 py-3">
                <h6 class="text-3xl lg:text-lg font-bold tracking-tight text-black dark:text-black">CSR 2023 Digital Office
                </h6>
                <p class="text-2xl lg:text-sm text-black dark:text-black">Mei 2023</p>
            </div>
        </div>
    </div>
