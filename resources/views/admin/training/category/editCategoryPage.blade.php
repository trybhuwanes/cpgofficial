...
@section('title', 'Admin | Edit Category Training')
...
@include('components.component')
    ...
    <div class="mt-4 mx-8 space-y-6">
        <form action="{{ route( 'admin.training.category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-5">
                ...
                <input type="text" id="name_category" name="name_category"
                    ...
                    placeholder="Write down the category" value="{{ $category->name_category }}" required />
            </div>
