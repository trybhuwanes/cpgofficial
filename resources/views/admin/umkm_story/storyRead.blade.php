...
@section('title', 'Admin | Read UMKM Story')
...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.umkm_story') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">UMKM Story</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Read UMKM Story</h1>
            </div>
        </div>
    </div>
    ...
    <div class="mt-4 mx-24 space-y-6">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="mb-5 my-10">
            <h3 class="mb-2 text-4xl font-bold tracking-tight text-white">{{ $story->title_story }}</h3>
