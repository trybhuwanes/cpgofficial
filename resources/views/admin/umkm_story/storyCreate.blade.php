    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Create UMKM Story</h1>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.umkm_story.create') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    aria-describedby="photo" id="pict_story" name="pict_story" type="file">
            </div>
