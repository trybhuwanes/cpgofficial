    ...
    <div class="mt-4 mx-8 space-y-6">
        <form action="{{ route('admin.umkm_story.create')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="photo" id="pict_story" name="pict_story" type="file">
            </div>
