...
@section('title', 'Admin | UMKM Story')
                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="{{ route('admin.umkm_story') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">UMKM Story</a>
                    </div>
                  </li>
                </ol>
            </nav>
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All UMKM Story</h1>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $item->title_story}}</div>
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                <div class="text-base font-semibold text-gray-900 dark:text-white">{{ Str::substr($item->body_story, 0, 40) }} ...</div>
                            </td>
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                <a href="{{ route('admin.umkm_story.read', ['id' => Crypt::encrypt($item->id)]) }}">
                                ...
                                <a href="{{ route('admin.umkm_story.edit.page', ['id' => Crypt::encrypt($item->id)]) }}">
                            ...
                            <a href="{{ route('admin.umkm_story.delete', ['id' => Crypt::encrypt($item->id)]) }}" onclick="return confirm('Are you sure?')">
                                ...
                                {{-- <form action="{{ route('admin.umkm_story.delete', ['id' => Crypt::encrypt($item->id)]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
