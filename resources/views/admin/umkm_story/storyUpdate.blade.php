    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.umkm_story') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">UMKM
                                    Story</a>
                            </div>
                        </li>
                        <li>
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Update UMKM Story</h1>
            </div>
        </div>
    </div>
