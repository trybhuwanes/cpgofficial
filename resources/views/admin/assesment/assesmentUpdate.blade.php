            ...
            <div class="mb-5 grid gap-4">
                @foreach ($syarat as $key => $item)
                    <div class="flex col-span-1 ">
                        <div
                            class="block w-1/2 py-1 mr-2 flex justify-center items-center bg-gray-800 h-24 border border-gray-200 rounded-md">
                        ...
                        <div>
                            <form
                                action="{{ route('admin.assesment.deleteSyarat', ['id' => Crypt::encrypt($item->id), 'idAssesment' => Crypt::encrypt($assesment->id)]) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
