...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.csr') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">CSR</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Update CSR Event</h1>
            </div>
        </div>
    </div>
    ...
    <div class="mt-4 mx-8 space-y-6">
        <form action="{{ route('admin.csr.edit', $csr->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Registration
                    Link</label>
                <input type="text" id="link_pendaftaran" name="link_pendaftaran"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Write down the registration link" value="{{ $csr->link_pendaftaran }}" required />
            </div>
            ...
            <div class="mb-5">
                <img id="image-preview" src="{{ asset('assets/img/' . $csr->pict_csr) }}" alt="{{ $csr->pict_csr }}"
