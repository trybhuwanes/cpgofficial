...
@section('title', 'Admin | Read CSR Event')
...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.csr') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">CSR
                                </a>
                            </div>
                        </li>
                        <li>
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Read CSR Event</h1>
            </div>
        </div>
    </div>
    ...
    <div data-aos="fade-up" data-aos-duration="1500" class="mx-20 mb-5 my-10">
        ...
        <h3 class="mb-2 text-4xl font-bold tracking-tight text-white">{{  $csr->title_csr }}</h3>
    </div>
    ...
    <div class="flex flex-wrap mx-20">
        <div data-aos="fade-up" data-aos-duration="1500" class="xl:w-2/3 sm:w-full ml-autoh-12 xl:pr-10 sm:pr-0">
            <img class="w-full aspect-square object-cover" src="{{ asset($csr->pict_csr) }}" alt="{{ $csr->pict_csr }}">
        </div>
        <div
