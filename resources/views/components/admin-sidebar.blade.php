<nav class="py-1 mb-2 fixed top-0 z-50 w-full bg-white dark:bg-gray-800 dark:border-gray-700">
    <button id="mobile-menu-button" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button"
    ...
    <ul class="hidden lg:flex space-x-4" id="menu-items">
        <li><a href="{{ route('admin.dashboard') }}" class="inline-block px-7 py-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</a></li>
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <a href="/admin" class="flex items-center pl-20 py-4">
        ...
        <ul id="" class="space-y-2 font-medium">
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Training Event</span>
                </a>
            </li>
            <li>
                <a href="#"
